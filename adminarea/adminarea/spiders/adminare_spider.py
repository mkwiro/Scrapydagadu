...
class AdminSpider(scrapy.Spider):
    ...
    start_urls = [
        'http://103.27.36.114/sipandu2/ID_barang_perbandingan.php?date2='+ str(date.strftime("%d-%m-%Y")) +'&katakunci=&b1=kosong&b2='+ str(b2[1]) +'&b3=kosong&b11=kosong&b10=kosong&b4=kosong&b5=kosong&b6=kosong&b7=kosong&b8=kosong&txt_design=Semua+Design&b9=kosong&b12=kosong&PageSize=20&cHidden=1&cSubmit=Cari'
        ]
#    start_urls = [
